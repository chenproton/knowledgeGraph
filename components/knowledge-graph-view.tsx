...
import { GraphNodeDetail, GraphDetailStack } from '@/components/graph-node-detail'
...
function KnowledgeGraphNode({ data, selected }: NodeProps & { selected?: boolean }) {
...
export function KnowledgeGraphView({ nodes, edges, title, description, compact, className, toolbarSlot, highlightNodeIds, nodeLabels, role }: GraphViewProps) {
            ...
            <CardContent className="flex-1 overflow-auto">
              {selectedNode ? (
                <div className="space-y-3">
                  ...
                  <Separator />
                  <GraphNodeDetail node={selectedNode} role={role} />
                </div>
              ) : (
