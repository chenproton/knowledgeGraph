...
export default function HistoryPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="执行记录"
        desc="数据由全业务工单系统自动同步，平台内无需做相关反馈操作"
      />

      <div className="flex items-center gap-2 rounded-lg border border-indigo-100 bg-gradient-to-br from-indigo-50 to-purple-50/40 p-3 text-xs text-muted-foreground">
        <Database className="size-4 shrink-0 text-indigo-500" />
        以下数据源从全业务工单系统对接获取，仅作只读展示。层级：记录 → 任务 → 任务分类 → 问题类型 → 具体问题 → 扣分项
      </div>
