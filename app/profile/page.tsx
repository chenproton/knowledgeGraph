        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-0.5 text-sm text-muted-foreground">
              最终学习成效评估：问题变化、五维能力提升、技能稳定性指标
            </p>
          </div>
        </div>
        <span className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-[#5b76e8] to-[#8c6ff0] px-3 py-1.5 text-xs font-semibold text-white shadow-sm">
          <Activity className="size-3.5" /> 综合均分 {overallAvg}
        </span>
      </div>
